...
## Auditoría documental vigente (4 sep 2026)
...
## Auditoría documental anterior (15 ago 2026)

| Archivo | Formato | Descripción |
|---|---|---|
| [AUDITORIA_DOCUMENTAL_2026-08-15.md](./AUDITORIA_DOCUMENTAL_2026-08-15.md) | Markdown | Histórico. Cifras (13 blueprints, 16 services, login solo-código) **ya no describen el código**. Conservar; no usar como fuente operativa. |
