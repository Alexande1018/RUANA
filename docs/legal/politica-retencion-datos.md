...
| Centro de comunicación / soporte | `ruana_soporte_conversaciones`, `ruana_soporte_mensajes` | Misma BD | Hasta resolver + 12 meses. Si hay reclamación con trascendencia legal o fiscal: 6 años desde el cierre del ejercicio | Canal de soporte y disconformidades |
| Apelación de expulsión (art. 22 RGPD) | `ruana_soporte_conversaciones` (`tipo=apelacion_expulsion`, `fecha_limite_apelacion`, `apelacion_metadata`, `decision_*`) + mensajes y `notificaciones_aliado` | Misma BD | Hasta resolver o vencer + 12 meses. Si hay reclamación o efecto sobre la relación contractual: 6 años desde el cierre del ejercicio | Garantía art. 22.3: plazo de 5 días hábiles, decisión humana y constancia de aceptación/rechazo/vencimiento. Operativo desde el 12 de septiembre de 2026 |
...
| Competencias por plaza | tablas de competencia / permanencia | Misma BD | Durante la relación + 12 meses tras la baja | Asignación de plazas. La expulsión automática por segunda derrota abre apelación (`apelacion_expulsion`) |
...
- **Artículo 22 RGPD (12 de septiembre de 2026):** la expulsión automática por segunda derrota en competencia sigue siendo una decisión automatizada con efectos equivalentes a los jurídicos. Ya no es una limitación sin resolver: existe un mecanismo real de apelación (`apelacion_expulsion`) con plazo de 5 días hábiles, notificación al aliado, revisión humana (aceptar/rechazar con motivo) y cierre por vencimiento sin respuesta. La expulsión no se retrasa: es inmediata; la apelación puede revertir estado, score y derrotas, no la plaza del ganador.
