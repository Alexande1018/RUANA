...
# Aliado login/logout/sesion + validar-invitacion → web.blueprints.auth_bp
...
# Ciclo de vida contactos (/api/contactos*, pago pendiente) → web.blueprints.contactos_bp
...
# validar-invitacion / invitaciones/validar → web.blueprints.auth_bp
