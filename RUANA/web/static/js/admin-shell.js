...
(function () {
    ...
    const NAV_SECTIONS = [
        ...
        { id: 'contactos-chat', label: 'Contactos con chat', group: 'Trabajos', module: 'trabajos', target: '#contactos-chat-admin-wrap', icon: 'message' },
        ...
        sidebar.innerHTML = `
            ...
            <div class="admin-sidebar-footer">
                ...
                <nav class="ruana-legal-nav-inline" aria-label="Información legal">
                    ...
                    <a href="/politica-privacidad.html#cookies">Cookies</a>
