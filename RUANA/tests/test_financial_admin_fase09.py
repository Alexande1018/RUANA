...
def test_02_dashboard_sin_permisos_explicitos_no_accede(client, sqlite_db, monkeypatch, session_headers):
    """Sesión admin sin lista de permisos no hereda el conjunto completo."""
