...
class DBManager:
    ...
    def _migrar_grupo_madre_v2_consolidar_si_procede(self, conn, cursor) -> None:
    ...
    def _migrar_estado_financiero(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_estado_financiero."""
        return schema_service._migrar_estado_financiero(self, conn, cursor)

    def _migrar_financial_fase02(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase02."""
        return schema_service._migrar_financial_fase02(self, conn, cursor)

    def _migrar_financial_fase03(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase03."""
        return schema_service._migrar_financial_fase03(self, conn, cursor)

    def _migrar_financial_fase03_1(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase03_1."""
        return schema_service._migrar_financial_fase03_1(self, conn, cursor)

    def _migrar_financial_fase03_2(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase03_2."""
        return schema_service._migrar_financial_fase03_2(self, conn, cursor)

    def _migrar_financial_fase04_conflicts(self, conn, cursor) -> None:
    ...
    def _migrar_financial_fase06_disputes(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase06_disputes."""
        return schema_service._migrar_financial_fase06_disputes(self, conn, cursor)

    def _migrar_financial_fase07_reconciliation(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase07_reconciliation."""
        return schema_service._migrar_financial_fase07_reconciliation(self, conn, cursor)

    def _migrar_financial_fase08_ledger(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase08_ledger."""
        return schema_service._migrar_financial_fase08_ledger(self, conn, cursor)

    def _migrar_financial_fase09_admin_panel(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase09_admin_panel."""
        return schema_service._migrar_financial_fase09_admin_panel(self, conn, cursor)

    def _migrar_financial_fase10_security(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase10_security."""
        return schema_service._migrar_financial_fase10_security(self, conn, cursor)

    def _migrar_financial_fase11_automation(self, conn, cursor) -> None:
        """Fachada Campamento Base → schema_service._migrar_financial_fase11_automation."""
        return schema_service._migrar_financial_fase11_automation(self, conn, cursor)
