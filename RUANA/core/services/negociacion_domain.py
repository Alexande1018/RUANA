"""Reglas de dominio de negociación guiada (Campamento Base).

Lógica pura de estado/pasos de negociación — sin acceso a BD.
Extraído de core/negociacion_manager.py; ese módulo permanece como fachada
de compatibilidad (reexporta este dominio).
"""
